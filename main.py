...
def adicionar_item_tarefa(tarefa):
    ...
    label_tarefa = tk.Label(frame_tarefa, text=tarefa, font=("Garamod, 16"), bg="white", width=25, height=2, anchor="w")
...
font.cabecalho = font.Font(family="Garamond", size=24, weight="bold")
rotulo_cabecalho = tk.Label(janela, text="Meu app de Tarefas", font=font.cabecalho, bg="#F0F0F0", fg="#333").pack(pady=20)
